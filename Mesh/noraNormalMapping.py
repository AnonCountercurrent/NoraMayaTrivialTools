...
class NoraNormalMapping(QtWidgets.QDialog, noraNormalMappingWidget.Ui_noraNormalMappingWidget):
    def __init__(self):
        ...
        self.curve_select_widget.set_label_text("Center/Curve: ")
    ...
    def normal_mapping(self):
        ...
        shell_target_dag_path = self.shell_select_widget.dag_name
        ...
        if self.selected_vertices is None:
            # all points on mesh
            target_model_name = self.model_select_widget.dag_name
